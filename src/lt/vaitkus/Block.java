...
/**
 * This is the block class used to create the bricks that the player breaks in
 * the main game.
 */
...
public class Block extends Rectangle {
	...
	/**
	 * The value of the color to determine the amount of points the player gets upon
	 * destroying hte brick.
	 */
	int colorValue;
	...
	/**
	 * The speed at which the brick moves vertically.
	 */
	int dy = -1;

	/**
	 * The constructor for the brick. Chooses a color based on the random integer c
	 * that was passed in.
	 * 
	...
	/**
	 * Get the value of the color as an integer to determine the points the player
	 * gets for destroying the brick.
	 * 
	...
	/**
	 * The default drawn state of the bricks, with a color, x, y and height and
	 * width.
	 * 
	 * @param g the Graphic
	 */
	...
	public void moveUpAndDow(int winHeight, int limit) {
